// Popup script for TruthPilot extension
document.addEventListener('DOMContentLoaded', () => {
  ...
  function showResults(issues) {
    ...
    issues.forEach(issue => {
      ...
      confidenceElement.textContent = `Confidence: ${Math.round(issue.confidence * 100)}%`;
  ...
  analyzeBtn.addEventListener('click', async () => {
    try {
      ...
      // Check if the current page is a BBC news article
